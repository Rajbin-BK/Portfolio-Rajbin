    ...
    return (
        <div className='bg-mine relative overflow-x-hidden'>
            <div className='relative  text-white '>
                <Navbar />
                <BackToTopButton/>
                <div className='pt-2 md:pt-5 max-h-full w-full text-white'>
                    {/* 1st section */}
                    <div data-aos="fade-left" data-aos-duration="1500" className='py-2 md:py-10 text-white bg-transparent'>
                        <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2 '>
                            {/* left side */}
                            <div data-aos="fade-right" data-aos-duration="1500" className='flex-1 text-center md:text-left'>
                                <h6 className='text-3xl md:text-2xl  md:mb-4'>
                                    Hi, my name is
                                </h6>
                                <div className="text-6xl md:text-5xl font-extrabold
                                mb-2 md:mb-10 block w-full py-2 text-transparent bg-clip-text leading-12 bg-gradient-to-r from-blue-200 to-blue-800 lg:inline">Rajbin BK</div>
                                <div>
                                    <h2 className="text-2xl md:text-5xl -mt-4 mb-1 md:mb-4 block w-full py-2 text-transparent bg-clip-text leading-12 bg-gradient-to-r from-blue-700 to-blue-200 lg:inline">I build things for the web.</h2></div>
                                
                                <div className='text-2xl md:mt-4 md:text-3xl md:mb-4'>Welcome to my website! I am <Typewriter /></div>
                    ...
                    {/* 2nd section*/}
                    <div data-aos="fade-left" data-aos-duration="1500" className=' text-white bg-transparent mb-5'>
                        <div className='flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2'>

                            {/* left */}
                            <div data-aos="fade-right" data-aos-duration="1500" className='flex-1 relative '>
                                <img src='/home.png' alt='Logo'
                                    className='mt-4 z-20 relative rounded-3xl ' />
                            </div>
                            {/* right */}
                            <div className='flex-1 text-center md:text-left ml-4 lg:ml-16'>

                                <h2 data-aos="fade-left" data-aos-duration="1500" className="text-5xl md:text-5xl font-extrabold mb-5 py-2 text-transparent bg-clip-text leading-12 bg-gradient-to-r from-blue-200 to-blue-800 lg:inline">ALLOW ME TO INTRODUCE MYSELF</h2>

                                <p data-aos="fade-left" data-aos-duration="1500" className='text-justify text-lg md:text-xl  text-gray-200 mt-4'>
                                My passion for web development drives me to create innovative and impactful solutions. I am proficient in HTML, CSS, and JavaScript, always striving to explore new tools and technologies to enhance my skills.
                                    <br />
                                    <br /> With expertise in building full-stack applications using React.js, Node.js, and Next.js, I have developed projects that emphasize responsive design, real-time functionality, and dynamic user interactions. I&apos;m continuously expanding my knowledge in cloud computing, 3D interactive web apps, and real-time communication to push the boundaries of modern development.
                                </p>
